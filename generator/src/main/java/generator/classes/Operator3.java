...
public class Operator3 implements OperatorInterface {
  private Integer i;
  ...
  public List<OperatorInterface> initOperators() {
    ...
    for(int i = 0; i<=1; i += 1) {
      Operator3 operator3 = new Operator3(i);
      result.add(operator3);
    }
    return result;
  }
  ...
  public boolean equals(Object o) {
    ...
    Operator3 operator3 = (Operator3) o;

    return i != null ? i.equals(operator3.i) : operator3.i == null;
  }

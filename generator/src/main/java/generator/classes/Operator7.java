...
public class Operator7 implements OperatorInterface {
  private Integer i;
  ...
  public List<OperatorInterface> initOperators() {
    ...
    for(int i = 0; i<=1; i += 1) {
      Operator7 operator7 = new Operator7(i);
      result.add(operator7);
    }
    return result;
  }
  ...
  public boolean equals(Object o) {
    ...
    Operator7 operator7 = (Operator7) o;

    return i != null ? i.equals(operator7.i) : operator7.i == null;
  }
